...
for i, mDir in enumerate(momDir): 
    ...
    #binCentresSumAnglesTimeErr = 1/np.sqrt(errCounts)
    ...
    xDataSine = binCentresSumAnglesTime
    yDataSine = avgAngleTime
    xErrorSine = 0#binCentresSumAnglesTimeErr
    yErrorSine = avgAngleTimeErr
...
xdata = binCentresFreqMod[1:]
ydata = freqModArr[1:]
xerror = 0
#yerror = errCounts*1/countsTime
yerror = freqModErrorArr[1:]
...
# Output fit parameters
print("Fitted parameters: m = {0:.4f}, c = {1:.6f}".format(0, cFreqMod))
print("Parameter errors: d_m ={0:.2f}, d_c = {1:.8f}".format(0, d_cFreqMod))
